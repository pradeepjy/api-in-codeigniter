...
class Api extends REST_Controller{
    ...
    function books_get(){
     ...
     function single_books_get()
     {
        $id=$this->uri->segment(3); 
        $result = $this->book_model->single_books_get($id);
    ...
    function addBook_post(){
         ...
         if(!$name || !$price || !$author || !$price || !$isbn || !$category){
            ...
            $result = $this->book_model->add(array("name"=>$name, "price"=>$price, "author"=>$author, "category"=>$category, "language"=>$language, "isbn"=>$isbn));
